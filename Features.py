...
class Features ():
    ...
    def getNWords (self) :
        ...
        lSource=self.getNWordsSegment(self.sSegmentNoPunctuation)
        lTarget=self.getNWordsSegment(self.tSegmentNoPunctuation)
    ...
    def removeFirstWord (self,segment) :
        """Remove First word from segment """
    ...
    def haveNameEntity(self):
        ...
        nersSegment=self.removeFirstWord (self.sSegment)
        nertSegment=self.removeFirstWord (self.tSegment)
        return self.hasNameEntity(nersSegment), self.hasNameEntity(nertSegment)
    ...
    def getNameEntitiesSimilarity(self):
        ...
        matchSourceList=self.nameEntityDetection(nersSegment)
        matchDestinationList=self.nameEntityDetection(nertSegment)
